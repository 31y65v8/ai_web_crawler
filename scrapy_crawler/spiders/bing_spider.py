...
'''
使用scrapy直接爬取bing响应请求的html页面
'''

def create_bing_url(query, site=''):  # 构建url
    bing_dict = {'q': query, 'num': 10 }  # 创建字典，包括查询和结果数量
    if site:  # 如果提供了特定网站
...
'''
    ...
    def parse(self, response):
        ...
        if page_number < 5:  # 限制爬取的最大页数（这里是5页）
            # 获取下一页的链接
